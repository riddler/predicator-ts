/**
 * Types for the shared corpus rules, so that the runner and the registry check
 * read the vendored corpus through the same implementation the ratchet script
 * writes against.
 */
